...
import ExpoVideoPlayerListItem from './ExpoVideoPlayerListItem';

const ExpoVideoScreenTest3: React.FC = () => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <View style={styles.header}>
          <Text style={styles.headerTitle}>expo-video (audio only)</Text>
          <Text style={styles.subTitle}>using expo-video to play audio</Text>
        </View>
...
export default ExpoVideoScreenTest3;
